 ...
 */
 ...
 class TopologyMapRoot extends Map {
     ...
     toolTipEvents() {
         ...
         return {
             ...
             pathclick: (selectedPath) => {
                 ...
                 var rootPathID = selectedPath.id;
     ...
     expandPath(selectedPathID) {
         console.log("selectedPathID inside expandpath: ",selectedPathID);
     ...
     componentWillMount() {
        ...
        // }).then((res)=> {
 var res={data:{"entityAttributes":{"Policy":{"defaultAttribute":[{"visibleColumn":"Policy Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"}],"specificAttribute":[{"availableColumn":"qosSessionProfileLogFlowType","entityAttribute":"qosSessionProfileLogFlowType"},{"availableColumn":"RootNetworkElement","entityAttribute":"RootNetworkElement"},{"availableColumn":"Primary Label","entityAttribute":"PrimaryLabel"},{"availableColumn":"Base Mac Address","entityAttribute":"CreationDate"},{"availableColumn":"Category","entityAttribute":"Category"},{"availableColumn":"qosSessionProfileRefCount","entityAttribute":"qosSessionProfileRefCount"},{"availableColumn":"Down Policy","entityAttribute":"DownPolicy"},{"availableColumn":"Remote Up Policy","entityAttribute":"RemoteUpPolicy"},{"availableColumn":"Down Policer","entityAttribute":"DownPolicer"},{"availableColumn":"Tenant SureName","entityAttribute":"TenantSureName"},{"availableColumn":"qosSessionProfileVersion","entityAttribute":"qosSessionProfileVersion"},{"availableColumn":"UUID","entityAttribute":"UUID"},{"availableColumn":"Up Policy","entityAttribute":"UpPolicy"},{"availableColumn":"Profile NR","entityAttribute":"profileNr"},{"availableColumn":"qosSessionProfileDnDefaultTc","entityAttribute":"qosSessionProfileDnDefaultTc"},{"availableColumn":"Created By","entityAttribute":"CreatedBy"},{"availableColumn":"Up Policer","entityAttribute":"UpPolicer"},{"availableColumn":"Remote Down Policy","entityAttribute":"RemoteDownPolicy"},{"availableColumn":"toQosMarkerProfile","entityAttribute":"toQosMarkerProfile"},{"availableColumn":"qosSessionProfileDsScheduleTag","entityAttribute":"qosSessionProfileDsScheduleTag"},{"availableColumn":"Marker","entityAttribute":"Marker"},{"availableColumn":"qosSessionProfileUpDefaultTc","entityAttribute":"qosSessionProfileUpDefaultTc"},{"availableColumn":"qosSessionProfileName","entityAttribute":"qosSessionProfileName"},{"availableColumn":"Context Id","entityAttribute":"ContextId"}]},"Path":{"defaultAttribute":[{"visibleColumn":"Path Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"},{"visibleColumn":"STATE.AdministrativeState","entityAttribute":"STATE_AdministrativeState"},{"visibleColumn":"STATE.OperationalState","entityAttribute":"STATE_OperationalState"},{"visibleColumn":"CAPACITY_Speed","entityAttribute":"CAPACITY_Speed"}],"specificAttribute":[{"availableColumn":"Active Path A Z","entityAttribute":"activePathAZ"},{"availableColumn":"Active Path Z A","entityAttribute":"activePathZA"},{"availableColumn":"Actual Hop 1","entityAttribute":"ActualHop1"},{"availableColumn":"Actual Hop 2","entityAttribute":"ActualHop2"},{"availableColumn":"Actual Hop 3","entityAttribute":"ActualHop3"},{"availableColumn":"Actual Hop Record Label 1","entityAttribute":"ActualHopRecordLabel1"},{"availableColumn":"Actual Hop Record Label 2","entityAttribute":"ActualHopRecordLabel2"},{"availableColumn":"Actual Hop Record Label 3","entityAttribute":"ActualHopRecordLabel3"},{"availableColumn":"Actual Path MTU","entityAttribute":"actualPathMtu"},{"availableColumn":"Adaptive","entityAttribute":"adaptive"},{"availableColumn":"Admin Group Exclude","entityAttribute":"adminGroupExclude"},{"availableColumn":"Admin Group Include","entityAttribute":"adminGroupInclude"},{"availableColumn":"Area Id","entityAttribute":"AreaId"},{"availableColumn":"A Termination Name","entityAttribute":"ATerminationName"},{"availableColumn":"Bi Directional","entityAttribute":"biDirectional"},{"availableColumn":"BW Threashold",
"entityAttribute":"BWTHRESHOLD.cos0"},{"availableColumn":"Category","entityAttribute":"Category"},{"availableColumn":"Computed Hop 1","entityAttribute":"ComputedHop1"},{"availableColumn":"Computed Hop 2","entityAttribute":"ComputedHop2"},{"availableColumn":"Computed Hop 3","entityAttribute":"ComputedHop3"},{"availableColumn":"Connection Type","entityAttribute":"connectionType"},{"availableColumn":"CSPF Enabled","entityAttribute":"cspfEnabled"},{"availableColumn":"Destination IP Address","entityAttribute":"destinationIPAddr"},{"availableColumn":"Destination IP Address","entityAttribute":"destinationIpAddress"},{"availableColumn":"Destination Node Id","entityAttribute":"destNodeId"},{"availableColumn":"Destination Node Name","entityAttribute":"destNodeName"},{"availableColumn":"Discovery Level","entityAttribute":"DiscoveryLevel"},{"availableColumn":"Enable Te Metric","entityAttribute":"enableTeMetric"},{"availableColumn":"Encapsulation Type","entityAttribute":"encapsulationType"},{"availableColumn":"Endpoint A Name","entityAttribute":"endpointAName"},{"availableColumn":"Endpoint A Pointer","entityAttribute":"endpointAPointer"},{"availableColumn":"Endpoint A Site Id","entityAttribute":"endPointASiteId"},{"availableColumn":"Endpoint A Site Name","entityAttribute":"endPointASiteName"},{"availableColumn":"Endpoint B Pointer","entityAttribute":"endpointBPointer"},{"availableColumn":"Endpoint B Site Id","entityAttribute":"endPointBSiteId"},{"availableColumn":"Endpoint B Site Name","entityAttribute":"endPointBSiteName"},{"availableColumn":"Endpoint Z Name","entityAttribute":"endpointZName"},{"availableColumn":"Entity Sequence Number","entityAttribute":"EntitySequenceNumber"},{"availableColumn":"Explicit Hop 1","entityAttribute":"ExplicitHop1"},{"availableColumn":"Explicit Hop 2","entityAttribute":"ExplicitHop2"},{"availableColumn":"Fast Reroute Enabled","entityAttribute":"fastRerouteEnabled"},{"availableColumn":"Hold Priority","entityAttribute":"holdPriority"},{"availableColumn":"Hop Limit","entityAttribute":"hopLimit"},{"availableColumn":"IGP Metric","entityAttribute":"igpMetric"},{"availableColumn":"Interface Class","entityAttribute":"interfaceClass"},{"availableColumn":"Interface Type","entityAttribute":"interfaceType"},{"availableColumn":"Is Passive","entityAttribute":"isPassive"},{"availableColumn":"Level 1 Metric","entityAttribute":"Level1Metric"},{"availableColumn":"Level Capability","entityAttribute":"levelCapability"},{"availableColumn":"Link Type","entityAttribute":"linkType"},{"availableColumn":"LSP Id","entityAttribute":"lspId"},{"availableColumn":"MTU","entityAttribute":"MTU"},{"availableColumn":"Name","entityAttribute":"name"},{"availableColumn":"Notes","entityAttribute":"notes"},{"availableColumn":"Number of Xcs","entityAttribute":"numberOfXcs"},{"availableColumn":"Number of Xcs Present","entityAttribute":"numberOfXcsPresent"},{"availableColumn":"Object Full Name","entityAttribute":"objectFullName"},{"availableColumn":"Och Xc Id","entityAttribute":"ochXcId"},{"availableColumn":"Optical Link Id","entityAttribute":"opticalLinkId"},{"availableColumn":"Optical Link Type","entityAttribute":"opticalLinkType"},{"availableColumn":"Path Id","entityAttribute":"pathId"},{"availableColumn":"Path Mtu","entityAttribute":"pathMtu"},{"availableColumn":"Path Transport","entityAttribute":"pathTransport"},{"availableColumn":"Port A Pointer","entityAttribute":"portAPointer"},{"availableColumn":"Port Z Pointer","entityAttribute":"portZPointer"},{"availableColumn":"Protection","entityAttribute":"protection"},{"availableColumn":"Protection Enabled","entityAttribute":"protectionEnabled"},{"availableColumn":"Protection Level","entityAttribute":"protectionLevel"},{"availableColumn":"Protection Scheme","entityAttribute":"protectionScheme"},{"availableColumn":"Protection State","entityAttribute":"protectionState"},{"availableColumn":"Protocol Type","entityAttribute":"protocolType"},{"availableColumn":"Rate","entityAttribute":"rate"},{"availableColumn":"Retry Limit","entityAttribute":"retryLimit"},{"availableColumn":"Retry Timer","entityAttrib
ute":"retryTimer"},{"availableColumn":"RSVP Style","entityAttribute":"rsvpStyle"},{"availableColumn":"Service Id","entityAttribute":"ServiceId"},{"availableColumn":"Service Mode","entityAttribute":"serviceMode"},{"availableColumn":"Service Name","entityAttribute":"serviceName"},{"availableColumn":"Setup Priority","entityAttribute":"setupPriority"},{"availableColumn":"Signalling Type","entityAttribute":"signallingType"},{"availableColumn":"Site Id","entityAttribute":"siteId"},{"availableColumn":"Site Name","entityAttribute":"siteName"},{"availableColumn":"Source IP Address","entityAttribute":"sourceIPAddr"},{"availableColumn":"Source IP Address","entityAttribute":"sourceIpAddress"},{"availableColumn":"Source Node Id","entityAttribute":"sourceNodeId"},{"availableColumn":"Source Node Name","entityAttribute":"sourceNodeName"},{"availableColumn":"SVC Component Id","entityAttribute":"svcComponentId"},{"availableColumn":"SVC Connection Type","entityAttribute":"svcConnectionType"},{"availableColumn":"SVC Tunnel Type","entityAttribute":"svcTunnelType"},{"availableColumn":"TE Metric","entityAttribute":"teMetric"},{"availableColumn":"Template","entityAttribute":"Template"},{"availableColumn":"Trail Id","entityAttribute":"trailId"},{"availableColumn":"Trail Pointer","entityAttribute":"trailPointer"},{"availableColumn":"Version","entityAttribute":"version"},{"availableColumn":"VLAN VC Ether Type","entityAttribute":"vlanVcEtherType"},{"availableColumn":"XC Type","entityAttribute":"xcType"},{"availableColumn":"Z Termination Name","entityAttribute":"ZTerminationName"},{"availableColumn":"URL","entityAttribute":"URL"}]},"tenants":{"defaultAttribute":[{"visibleColumn":"Tenant","entityAttribute":"SureName"},{"visibleColumn":"Address","entityAttribute":"Address"},{"visibleColumn":"City","entityAttribute":"City"},{"visibleColumn":"Country","entityAttribute":"Country"},{"visibleColumn":"Status","entityAttribute":"State"}],"specificAttribute":[{"availableColumn":"Creation Date","entityAttribute":"CreationDate"},{"availableColumn":"Last Update Date","entityAttribute":"LastUpdateDate"}]},"InComingAssocation":{"defaultAttribute":[{"visibleColumn":"Source Type","entityAttribute":"SourceType"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Association Type","entityAttribute":"AssociationType"},{"visibleColumn":"Source Name","entityAttribute":"SourceName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"}],"specificAttribute":[{"availableColumn":"Association Attr1","entityAttribute":"Attr1"},{"availableColumn":"Association Attr2","entityAttribute":"Attr2"},{"availableColumn":"Association Attr3","entityAttribute":"Attr3"}]},"Customer":{"defaultAttribute":[{"visibleColumn":"Customer Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"}],"specificAttribute":[{"availableColumn":"Base Mac Address","entityAttribute":"CreationDate"},{"availableColumn":"Category","entityAttribute":"Category"},{"availableColumn":"Created By","entityAttribute":"CreatedBy"},{"availableColumn":"Down Policy","entityAttribute":"DownPolicy"},{"availableColumn":"UUID","entityAttribute":"UUID"},{"availableColumn":"Label","entityAttribute":"Label"},{"availableColumn":"contextId","entityAttribute":"contextId"}]},"profiles":{"defaultAttribute":[{"visibleColumn":"Profile Name","entityAttribute":"ProfileName"},{"visibleColumn":"Description","entityAttribute":"Description"}]},"groups":{"defaultAttribute":[{"visibleColumn":"Group","entityAttribute":"SureName"},{"visibleColumn":"GroupId","entityAttribute":"GroupId"},{"visibleColumn":"Number of Users","entityAttribute":"Count"}]},"Service":{"defaultAttribute":[{"visibleColumn":"Service Name","entityAttribute":"SureName"},{"visibleColumn":
"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"},{"visibleColumn":"STATE.AdministrativeState","entityAttribute":"STATE_AdministrativeState"},{"visibleColumn":"STATE.OperationalState","entityAttribute":"STATE_OperationalState"}],"specificAttribute":[{"availableColumn":"Category","entityAttribute":"Category"},{"availableColumn":"Direction","entityAttribute":"direction"},{"availableColumn":"Discovery Level","entityAttribute":"DiscoveryLevel"},{"availableColumn":"Network Interface Id","entityAttribute":"NetworkInterfaceId"},{"availableColumn":"Object Full Name","entityAttribute":"objectFullName"},{"availableColumn":"Rate","entityAttribute":"rate"},{"availableColumn":"Service Id","entityAttribute":"ServiceId"},{"availableColumn":"Service Type","entityAttribute":"serviceType"},{"availableColumn":"SVC Tunnel Type","entityAttribute":"svcTunnelType"},{"availableColumn":"Template","entityAttribute":"Template"},{"availableColumn":"URL","entityAttribute":"URL"}]},"users":{"defaultAttribute":[{"visibleColumn":"First Name","entityAttribute":"Firstname"},{"visibleColumn":"Last Name","entityAttribute":"Lastname"},{"visibleColumn":"Username","entityAttribute":"Username"},{"visibleColumn":"Email","entityAttribute":"Email"},{"visibleColumn":"Inventory Role","entityAttribute":"Groups"},{"visibleColumn":"Status","entityAttribute":"Status"}]},"FCP":{"defaultAttribute":[{"visibleColumn":"FCP Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"},{"visibleColumn":"STATE.AdministrativeState","entityAttribute":"STATE_AdministrativeState"},{"visibleColumn":"STATE.OperationalState","entityAttribute":"STATE_OperationalState"},{"visibleColumn":"Capacity_Speed","entityAttribute":"Capacity_Speed"}],"specificAttribute":[{"availableColumn":"Active Path A Z","entityAttribute":"activePathAZ"},{"availableColumn":"Active Path Z A","entityAttribute":"activePathZA"},{"availableColumn":"Address Family","entityAttribute":"addressFamily"},{"availableColumn":"Administrative State","entityAttribute":"administrativeState"},{"availableColumn":"Auto Bind Ldp 1","entityAttribute":"autoBindLdp1"},{"availableColumn":"Auto Bind Ldp 2","entityAttribute":"autoBindLdp2"},{"availableColumn":"Auto Bind Rsvp Te 1","entityAttribute":"autoBindRsvpTe1"},{"availableColumn":"Auto Bind Rsvp Te 2","entityAttribute":"autoBindRsvpTe2"},{"availableColumn":"Bi Directional","entityAttribute":"biDirectional"},{"availableColumn":"Category","entityAttribute":"Category"},{"availableColumn":"Channel","entityAttribute":"channel"},{"availableColumn":"Circuit Type","entityAttribute":"circuitType"},{"availableColumn":"Connection Type","entityAttribute":"connectionType"},{"availableColumn":"Discovery Level","entityAttribute":"DiscoveryLevel"},{"availableColumn":"Enable Forwarding","entityAttribute":"enableForwarding"},{"availableColumn":"Encap Type","entityAttribute":"encapType"},{"availableColumn":"Endpoint A Name","entityAttribute":"endpointAName"},{"availableColumn":"Endpoint Z Name","entityAttribute":"endpointZName"},{"availableColumn":"Inner Encap Value","entityAttribute":"innerEncapValue"},{"availableColumn":"Interface Class","entityAttribute":"interfaceClass"},{"availableColumn":"IP Address","entityAttribute":"IpAddress"},{"availableColumn":"Is Primary","entityAttribute":"isPrimary"},{"availableColumn":"Lag Bandwidth","entityAttribute":"lagBandwidth"},{"availableColumn":"Lag Size","entityAttribute":"lagSize"},{"availableColumn":"Loopback Enabled","entityAttribute":"loopbackEnabled"},{"availableColumn":"Node Id","entityAttribute":"nodeId"},{"availableColumn":
"Node Name","entityAttribute":"nodeName"},{"availableColumn":"Object Full Name","entityAttribute":"objectFullName"},{"availableColumn":"Operational State","entityAttribute":"operationalState"},{"availableColumn":"Outer Encap Value","entityAttribute":"outerEncapValue"},{"availableColumn":"Path Id","entityAttribute":"pathId"},{"availableColumn":"Port Name","entityAttribute":"PortName"},{"availableColumn":"Port A Pointer","entityAttribute":"portAPointer"},{"availableColumn":"Port Z Pointer","entityAttribute":"portZPointer"},{"availableColumn":"Protection","entityAttribute":"protection"},{"availableColumn":"Protection Enabled","entityAttribute":"protectionEnabled"},{"availableColumn":"Protection Scheme","entityAttribute":"protectionScheme"},{"availableColumn":"Protection State","entityAttribute":"protectionState"},{"availableColumn":"Rate","entityAttribute":"rate"},{"availableColumn":"Route Distinguisher","entityAttribute":"routeDistinguisher"},{"availableColumn":"Service Id","entityAttribute":"serviceId"},{"availableColumn":"Site Id","entityAttribute":"siteId"},{"availableColumn":"Site Type","entityAttribute":"siteType"},{"availableColumn":"Subnet Prefix Length","entityAttribute":"subnetPrefixLength"},{"availableColumn":"Trail Id","entityAttribute":"trailId"},{"availableColumn":"VC Id","entityAttribute":"vcId"},{"availableColumn":"VC Precedence","entityAttribute":"vcPrecedence"},{"availableColumn":"VRF MVPN Target","entityAttribute":"vrfMVPNTarget"},{"availableColumn":"VRF MVPN Target as Value","entityAttribute":"vrfMVPNTargetASValue"},{"availableColumn":"VRF MVPN Target Extended Community Value","entityAttribute":"vrfMVPNTargetExtendedCommunityValue"},{"availableColumn":"VRF Target","entityAttribute":"vrfTarget"},{"availableColumn":"VRF Target as Value","entityAttribute":"vrfTargetASValue"},{"availableColumn":"URL","entityAttribute":"URL"}]},"Equipment":{"defaultAttribute":[{"visibleColumn":"Equipment Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"},{"visibleColumn":"STATE.AdministrativeState","entityAttribute":"STATE_AdministrativeState"},{"visibleColumn":"STATE.OperationalState","entityAttribute":"STATE_OperationalState"},{"visibleColumn":"CAPACITY_Speed","entityAttribute":"CAPACITY_Speed"}],"specificAttribute":[{"availableColumn":"URL","entityAttribute":"URL"},{"availableColumn":"Base Mac Address","entityAttribute":"baseMacAddress"},{"availableColumn":"Category","entityAttribute":"Category"},{"availableColumn":"Card Protection Type","entityAttribute":"cardProtectionType"},{"availableColumn":"Chassis Type","entityAttribute":"chassisType"},{"availableColumn":"Daughter Card Slot Id","entityAttribute":"daughterCardSlotId"},{"availableColumn":"Discovery Level","entityAttribute":"DiscoveryLevel"},{"availableColumn":"Latitude","entityAttribute":"GEOCODE.Latitude"},{"availableColumn":"Longitude","entityAttribute":"GEOCODE.Longitude"},{"availableColumn":"IP Address","entityAttribute":"IpAddress"},{"availableColumn":"Is Primary Lag Member","entityAttribute":"isPrimaryLagMember"},{"availableColumn":"Lag Membership Id","entityAttribute":"lagMembershipId"},{"availableColumn":"Number of Daughter Cards","entityAttribute":"numberOfDaughterCards"},{"availableColumn":"Number of Shelves","entityAttribute":"NumberOfShelves"},{"availableColumn":"Number of Slots","entityAttribute":"NumberOfSlots"},{"availableColumn":"Object Full Name","entityAttribute":"objectFullName"},{"availableColumn":"Port Name","entityAttribute":"portName"},{"availableColumn":"Serial Number","entityAttribute":"serialNumber"},{"availableColumn":"Shelf Id","entityAttribute":"shelfId"},{"availableColumn":"Site Name","entityAttribute":"siteName"},{"availableColumn":"Slot Id","entityAttribute":"slotId"},{"availableColumn":"System Address","entityAttribute":"systemAddress"},{"av
ailableColumn":"System Up Time","entityAttribute":"sysUpTime"}]},"Endpoint":{"defaultAttribute":[{"visibleColumn":"Endpoint Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"},{"visibleColumn":"STATE.AdministrativeState","entityAttribute":"STATE_AdministrativeState"},{"visibleColumn":"STATE.OperationalState","entityAttribute":"STATE_OperationalState"}],"specificAttribute":[{"availableColumn":"Category","entityAttribute":"Category"},{"availableColumn":"Discovery Level","entityAttribute":"DiscoveryLevel"},{"availableColumn":"Encap Type","entityAttribute":"encapType"},{"availableColumn":"Inner Encap Value","entityAttribute":"innerEncapValue"},{"availableColumn":"L3 Interface Name","entityAttribute":"L3InterfaceName"},{"availableColumn":"Loopback Enabled","entityAttribute":"loopbackEnabled"},{"availableColumn":"Node Id","entityAttribute":"nodeId"},{"availableColumn":"Node Name","entityAttribute":"nodeName"},{"availableColumn":"Object Full Name","entityAttribute":"objectFullName"},{"availableColumn":"Outer Encap Value","entityAttribute":"outerEncapValue"},{"availableColumn":"Port Name","entityAttribute":"portName"},{"availableColumn":"Port Pointer","entityAttribute":"portPointer"},{"availableColumn":"Service Id","entityAttribute":"ServiceId"},{"availableColumn":"URL","entityAttribute":"URL"}]},"usergroups":{"defaultAttribute":[{"visibleColumn":"Profile","entityAttribute":"Profile"},{"visibleColumn":"Description","entityAttribute":"Description"},{"visibleColumn":"Inventory Role","entityAttribute":"UserGroupName"}]},"GlobalSearch":{"defaultAttribute":[{"visibleColumn":"SURE Name","entityAttribute":"SureName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"}]},"customhook":{"defaultAttribute":[{"visibleColumn":"SureName","entityAttribute":"SureName"},{"visibleColumn":"CustomHookURL","entityAttribute":"CustomHookURL"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"}]},"Network":{"defaultAttribute":[{"visibleColumn":"Network Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Type","entityAttribute":"Type"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Domain Type","entityAttribute":"DomainType"},{"visibleColumn":"Layer","entityAttribute":"Layer"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"}],"specificAttribute":[{"availableColumn":"URL","entityAttribute":"URL"}]},"OutGoingAssocation":{"defaultAttribute":[{"visibleColumn":"Target Name","entityAttribute":"TargetName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Sub Type","entityAttribute":"SubType"},{"visibleColumn":"Target Type","entityAttribute":"TargetType"},{"visibleColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"visibleColumn":"Association Type","entityAttribute":"AssociationType"}],"specificAttribute":[{"availableColumn":"Association Attr1","entityAttribute":"Attr1"},{"availableColumn":"Association Attr2","entityAttribute":"Attr2"},{"availableColumn":"Association Attr3","entityAttribute":"Attr3"}]},"Location":{"defaultAttribute":[{"visibleColumn":"Location Name","entityAttribute":"SureName"},{"visibleColumn":"Display Name","entityAttribute":"DisplayName"},{"visibleColumn":"Latitude","entityAttribute":"Latitude"},{"visibleColumn":"Longitude","entityAttribute":"Longitude"},{"visibleColumn":"Last Update Date","entityAttribute":"LastUpdateDate"}],"specificAttribute":[{"availableColumn":"Discovered Name","entityAttribute":"DiscoveredName"},{"availableColumn":"Creation Date","entityAttribute":"CreationDate"},{"availableColumn":"URL","entityAttribute":"URL"}]}}}};
         ...
         pathsToDraw.forEach((pathFromLayerObj) => {
             ...
             if (path) { //path may be unknown node
                 ...
                 if (path.selectedPathID)// if any path selected then expand based on that path id
                 {
                     ...
                     console.log("isolated expand for path inside expandlayerv1:", path);
                 ...
                 if (pathFromLayerObj.type == "path" || pathFromLayerObj.type == "gPath") {
                     ...
                     console.log("paths inside expandlayerv1: : ",paths);
                     //ring code:

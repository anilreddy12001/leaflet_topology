...
*	
*	
*	var AssociationView = SUREUI.components.AssociationView;
...
import AssociationViewContainer  from '../containers/associationViewContainer';
import store from '../store/store';
import "../../styles/associationView.css"
class AssociationView extends React.Component{
     render(){
        return(
            <Provider store={store}>
                
    
<AssociationViewContainer gridData = {this.props} />
